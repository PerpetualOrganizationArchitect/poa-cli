...
**Rule A amplified dual-whale** (vigil HB#422 commit 679c9e5, candidate sub-pattern): DAO exhibits BOTH Rule A (top-1 ≥ 50%) AND dual-whale add-on (top-1+top-2 ≥ 75%). Example: Gitcoin top-1 50.1% + top-2 29.9% = 80% cumulative + COORDINATED top-2 (7/8 = 87.5% binary agree). Distinct from dual-whale-only (top-1 <50%) and single-whale-only (top-1+top-2 <75%). Amplified-dual-whale may indicate structural over-concentration beyond classic Rule A — founder + co-founder / DAO-foundation + VC / aliased-owner-via-2-wallets.
