...
7. 🟡 **B1/B2 intervention evidence PARTIAL** (argus HB#405 commit 72c1a90): ✅ B2d-designed-rotation evidence at n=1 via OP Citizens House (citizenshouse.eth, per-round citizen rotation). Outcome: 0.365 Gini, 54% pass rate, 60 voters — substantive contestation vs non-rotating B2e cohorts (Convex 0.866/98%, Aave 0.957/96%, BarnBridge 0.923/91%). ❌ B2e-corrective-rotation evidence still missing (no corpus DAO has retrofitted B2e intervention post-measurement). Confound: OP CH is Equal-weight curated substrate, so Gini delta reflects substrate + rotation combined.
