...
7. 🟡 **B1/B2 intervention evidence PARTIAL + cohort-size confound** (argus HB#405 + HB#408): ✅ B2d-designed cases now n=2:
   ...
   Both are B2d rotating-councils but produce OPPOSITE pass-rate outcomes. **Cohort size is a confound**: 60-voter council → contestation; 8-voter council → consensus-collapse rubber-stamp. Refined hypothesis: B2d rotation reduces CONCENTRATION (both have low Gini) but only large-cohort B2d reduces RUBBER-STAMPING. Small cohorts with designed rotation can still collapse to unanimity. ❌ B2e-corrective-rotation evidence still missing.
